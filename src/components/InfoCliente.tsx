    ...
    <div className={`grid gap-6 ${mobile ? 'grid-cols-1' : 'grid-cols-1 md:grid-cols-2'}`}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Informações completas sobre {cliente.nome}</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-2">
                ...
                <p><span className="font-medium">Data de Nascimento:</span> {formatDate(cliente.dataNascimento)}</p>
                <p><span className="font-medium">Estado Civil:</span> {cliente.estadoCivil}</p>
              </div>
            </div>
            <div>
              ...
              <h3 className="text-lg font-semibold mt-4 mb-2">Informações Financeiras</h3>
              <div className="space-y-2">
                <p><span className="font-medium">Renda Anual:</span> {formatCurrency(cliente.rendaAnual)}</p>
                <p><span className="font-medium">Patrimônio:</span> {formatCurrency(cliente.patrimonio)}</p>
              </div>
            </div>
          </div>
        </CardContent>
            ...
            <CardContent>
              {agenciaCliente ? (
                <div className="space-y-4">
                  <p><span className="font-medium">Nome da Agência:</span> {agenciaCliente.nome}</p>
                  <p><span className="font-medium">Código:</span> {agenciaCliente.codigo}</p>
                  <p><span className="font-medium">Endereço:</span> {agenciaCliente.endereco}</p>
                </div>
              ) : (
